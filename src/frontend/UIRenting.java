...
public class UIRenting extends Transaction {
    ...
    public void insertTransaction() {
        try {
            ...
            System.out.print("Input Transaction Date (YYYY-MM-DD) : ");
            String transDate = Main.sigmaSkibidi.nextLine();

            System.out.print("Input Rent Date (YYYY-MM-DD)        : ");
            String rentDate = Main.sigmaSkibidi.nextLine();
            
            System.out.print("Input Return Date (YYYY-MM-DD)      : ");
            String returnDate = Main.sigmaSkibidi.nextLine();
            
            LocalDate start = LocalDate.parse(rentDate);
    ...
    public void updateTransaction() {
        ...
        try {
            ...
            if(!strCust.isEmpty()) {
                ...
                if (newCust.getIdCustomer() != 0) rent.setCustomer(newCust);
            }
    ...
    private void showTable() {
        ...
        System.out.println("=============================================================================================================");
        System.out.printf("%-4s %-15s %-20s %-12s %-12s %-12s %-12s\n", "ID", "Customer", "Game", "Trans Date", "Rent Date", "Return Date", "Total Price");
        System.out.println("=============================================================================================================");
    ...
    public void manageRenting() {
        while (true) {
            ...
            try {
                ...
                switch (choice) {
                    case 1: insertTransaction(); break;
